...
1. On the **Create workspace** screen, do one of the following:
...
1. On the **My Profile** page, update or set any relevant fields.
...
1. From the **My workspace** drop-down list, select **My preferences**.
...
1. On the **My Preferences** page, complete the fields.
    ...
    |Default page edit mode|Select one of the following: <br> - **Edit**: Opens every page in **Edit** mode by default.<br> - **Read**: Opens every page in **Read** mode by default. <br>To make any edits on a page, change the mode to **Edit**.
...
1. On the **General** screen, complete the fields.
...
1. On the **Invite new members** screen, complete the fields.
    ...
    |Select role    |Select one of the following roles for all selected users:<br> - **Admin**: Can invite and delete members, edit workspace settings, manage spaces and users within the workspace, and assign roles to all members. The Admin role _cannot_ delete the workspace.<br> - **Member**: Has access to assigned spaces and can contribute content based on specific permissions.|
...
1. On the **Members** page, on the **Pending** tab, view all invited members who still need to accept their invitation.
    ...
    |Role           |Role or set of permissions assigned to the member (either **Admin** or **Member**). <br> For details about **Admin** and **Member** roles, see [Invite members for workspace collaboration](#invite-members-for-workspace-collaboration).|
    |Date           |Date when the invitation was sent. <br>If sent less than 24 hours ago, the system displays the amount of time passed since the invitation was sent. For example, 45 minutes ago.|
    |...            |Resend or revoke the invitation for the invited member.|



 1. On the **Members** page, on the **Members** tab, view all invited members who have accepted their invitation.
    ...
    |Role           |Role of the member, which can be one of the following: <br> - **Owner**: Can perform all operations related to the workspace, including inviting and deleting members, editing workspace settings, managing spaces and users within the workspace, assigning roles to all members, and deleting the workspace. <br> - **Admin**: Can invite and delete members, edit workspace settings, manage spaces and users within the workspace, and assign roles to all members. The Admin role _cannot_ delete the workspace. <br> - **Member**: Has access to assigned spaces and can contribute content based on specific permissions.
    |...            |Deletes the member.
...
6. On the **Add space members** screen, complete the fields.
    ...
    |Select role    |Select the role or set of permissions you want for the selected members:<br> - **Full access**: Has full access permissions to all space settings and pages. <br> - **Can edit**: Can create and edit pages in the space. <br> - **Can view**: Can view pages in the Space but _cannot_ edit them. |
...
6. On the **Export space** screen, complete the fields.
    ...
    |Field          |Description|
    |:--------------|:----------| 
    |Format         |Select the format in which you want to export the space: <br> - **Markdown** <br> - **HTML**|
...
If you no longer need a space, you can delete it. 

For example, you created a space for a small group of members and they have merged into a bigger group that belongs to a different space.
...
Instead of adding _individual_ members to a space, you can add _groups_. 

Assign a specific set of permissions to the entire group. Groups make it easy to grant multiple users access at the same time. In addition, creating groups ensures members have the correct permissions for working in the space.
...
5. On the **Add space members** screen, complete the fields.
    ...
    |Select role    |Select one of the following permission levels: <br> - **Full access**: Has administrative access to all space settings and pages, and full editing privileges. <br> - **Can edit**: Can create and edit pages in the space, but _cannot_ access space settings. <br> - **Can view**: Can view all page content but _cannot_ edit any content.|
...
* [Duplicate a page in the same space](#duplicate-a-page-in-the-same-space)
...
5. Once you have added content, you can share the page with other members of the space, manage comments, and do other actions related to the page (including but not limited to _move_, _export_, _print_, and _view page history_).
    ...
    |5     |Provides additional options, including: <br> - **Copy link**: Copies the link to the page for sharing with other users. <br> - **Full width**: Toggles to the full page width. <br> - **Page history**: Displays a history of page versions. <br> - **Move**: Moves the page to another space. <br> - **Export**: Exports the page to an external file. <br> - **Print PDF**: Prints a PDF of the page. <br> - **Move to trash**: Deletes the page (moves to trash).  
